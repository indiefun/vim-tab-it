...
if exists('loaded_tab_it') || &cp
    finish
endif
let g:showInTabline = 1

"autocmd VimEnter,BufNew,BufEnter,BufLeave,BufWritePost,VimResized * call UpdateStatus()
...
if exists("g:showInTabline")
    if !exists("g:statusbarUsrDef") || g:statusbarUsrDef == 0
        ...
        set tabline=%m\{%{&ff}:%{&fenc}:%Y}\ %#StatusLine#%{g:bufBStr}%#NowBuf#%{g:bufNStr}%#StatusLine#%{g:bufAStr}
    endif
endif
